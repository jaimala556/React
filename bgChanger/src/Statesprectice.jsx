...
const Statesprectice = () => {
    const [active,setActive] = useState("signin")

  return (
    <>
    <div className='min-h-screen flex-col dark:bg-gray-900'>
        <div>
            <button type='button' onClick={()=> setActive("signin")} className='bg-black text-white rounded-md m-1 p-2 '> SignIn</button>
            <button type='button' onClick={()=> setActive("signUp")} className='bg-black text-white rounded-md m-1 p-2 '> SignUp</button>
        </div>
        <div>
            {
